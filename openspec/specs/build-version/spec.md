# Capability: build-version

## Purpose
Defines how version metadata is injected into the Go binary at build time via ldflags, and how it is exposed as a package for other components to consume.
