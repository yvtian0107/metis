# Capability: dev-postgres-seed

## Purpose
Provides development-time PostgreSQL configuration defaults and Makefile targets for database lifecycle management (seed, reset, clean).
