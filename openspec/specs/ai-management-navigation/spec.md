# Capability: ai-management-navigation

## Purpose

Defines the AI management information architecture in the main application sidebar, including stable group ordering, third-level resource navigation, and route behavior for tooling resources.
