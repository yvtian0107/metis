# Spec: Org Assignment Integrity

## Purpose

Define integrity and correctness requirements for the Org App's user-position assignment operations, ensuring atomic primary transitions, proper foreign key validation, and safe error propagation.
