...
func TestPositionRepo_CreateFindByIDFindByCode(t *testing.T) {
	...
	pos := &domain.Position{Name: "Senior Engineer", Code: "se", IsActive: true}
...
func TestPositionRepo_Update(t *testing.T) {
	...
	pos := testutil.SeedPosition(t, db, "Engineer", "eng", true)
...
func TestPositionRepo_InUse(t *testing.T) {
	...
	unusedPos := testutil.SeedPosition(t, db, "Manager", "mgr", true)
